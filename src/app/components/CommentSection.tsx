        ...
        {comments.map((comment, index) => (
          ...
          >
            <div className="flex items-start gap-3 mb-3">
              <div className="w-10 h-10 bg-gradient-to-br from-gray-300 to-gray-400 rounded-full flex-shrink-0 overflow-hidden shadow-sm flex items-center justify-center">
                {comment.userAvatar ? (
